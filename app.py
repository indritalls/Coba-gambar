...
channel_secret = os.getenv('f470cac6f78984857d780a3b2a5e90fd', None)
channel_access_token = os.getenv('lIKFwU/TgvvYQAVMTT0V3L/Q4MJUnjZFb4TdtVb4xeb3YRAVMkRusqyAiIifWjdhFzwiWPT0u8F4B9iB1ILEjXqWEjNEy9xvClCqk8xnFjPVfl1MLFsJ/k6nam1Y94ksJNiLuuU0poOvR905pXJ8JwdB04t89/1O/w1cDnyilFU=', None)
...
def handle_text_message(event):
    ...
    if text == 'profile':
        ...
        bubble = BubbleContainer(
            direction='ltr',
            hero=ImageComponent(
                url='https://i.imgur.com/41lXWjP.png',
                size='full',
                aspect_ratio='20:13',
                aspect_mode='cover',
                action=URIAction(uri='https://id.wikipedia.org/wiki/Ada_Apa_dengan_Cinta%3F_2', label='label')
            ),
            body=BoxComponent(
                layout='vertical',
                contents=[
                    ...
                    BoxComponent(
                        ...
                        margin='md',
                        contents=[
                            IconComponent(size='sm', url='https://static4.depositphotos.com/1018226/327/v/600/depositphotos_3273093-stock-illustration-3d-star-illustration-vector.jpg'),
                            IconComponent(size='sm', url='https://static4.depositphotos.com/1018226/327/v/600/depositphotos_3273093-stock-illustration-3d-star-illustration-vector.jpg'),
                            IconComponent(size='sm', url='https://static4.depositphotos.com/1018226/327/v/600/depositphotos_3273093-stock-illustration-3d-star-illustration-vector.jpg'),
                            IconComponent(size='sm', url='https://static4.depositphotos.com/1018226/327/v/600/depositphotos_3273093-stock-illustration-3d-star-illustration-vector.jpg'),
                            IconComponent(size='sm', url='https://static4.depositphotos.com/1018226/327/v/600/depositphotos_3273093-stock-illustration-3d-star-illustration-vector.jpg'),
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='WEBSITE', uri="https://id.wikipedia.org/wiki/Ada_Apa_dengan_Cinta%3F_2")
                    )
                ]
            ),
        )
